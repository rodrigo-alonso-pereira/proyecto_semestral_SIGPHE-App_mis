...
create table loans (
    ...
    total_rental numeric(10,2) not null,
    ...
    constraint loans_total_rental_check check (total_rental >= 0),
    constraint loans_total_penalties_check check (total_penalties >= 0),
